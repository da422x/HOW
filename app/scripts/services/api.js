...
// 		}),
		...
		getCurrentEvent: $resource(extension + '/events/:event_id',
			{event_id: '@event_id'}, {
				query: { method: 'GET', isArray: false} // explicit default GET retrieves single
			}),
		getMembersByEvent: $resource(extension + '/events/:event_id/members',
			{event_id: '@event_id'}, {
				query: { method: 'GET', isArray: true } // explicit default GET retrieves single
			}),
...
//			query: { method: 'GET' } // implied default GET retrieves all
		...
		getChapterItems: $resource(extension + '/chapter/:chapter_id/items', {
			...
			query: { method: 'GET', isArray: true } // implied default GET retrieves all
		}),
...
//			}),
		retrieveLogin: $resource(extension + '/member/get_login/:member_id', {id: '@id'}, {
			query: { method: 'GET' } // explicit default GET retrieves single
		}),
		updateLogin: $resource(extension + '/member/login/update/:member_id', {id: '@id'}, {
			update: { method: 'PUT' }
		}),
		memberUpdateChapter: $resource(extension + '/member/:member_id/change_chapter/:from_chapter_id/:to_chapter_id', {member_id: '@member_id', from_chapter_id: '@from_chapter_id', to_chapter_id: '@to_chapter_id'}, {
			update: { method: 'PUT' }
		}),
