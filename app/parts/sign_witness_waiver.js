...
angular.module('ohanaApp')
    .controller('SignWitnessWaiverCtrl', ['$scope', '$rootScope', '$q', 'commonServices', 'userService', '$uibModalInstance', 'howLogService',
        function($scope, $rootScope, $q, commonServices, userService, $uibModalInstance, howLogService) {
            'use strict';
            var d = document;
            ...
            $scope.submitData = function() {
                ...
                commonServices.pushData('/userData/' + userService.getId() + '/witness', $scope.superObj);
